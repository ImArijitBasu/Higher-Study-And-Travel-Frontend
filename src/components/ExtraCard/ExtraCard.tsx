...
export default function DestinationsCarousel() {
  ...
  return (
    <section ref={carouselRef} className="py-20 bg-gradient-to-br from-slate-50 via-white to-blue-50/30 relative overflow-hidden">
      {/* Background Elements */}
      ...
      <div className="relative z-10 max-w-11/12 mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            Discover our handpicked selection of amazing destinations around the world. 
            Curated for unforgettable experiences and adventures.
          </motion.p>
        </motion.div>
            ...
            >
              {extendedDeals.map((deal, index) => (
                <motion.div
                  ...
                  className="flex-shrink-0 w-1/4 px-2" // 4 cards per view
                  whileHover="hover"
                ...
                >
                  <motion.div
                    ...
                    className="relative bg-white rounded-3xl shadow-xl hover:shadow-2xl border border-gray-100 overflow-hidden transition-all duration-500 group"
                  >
                    {/* Image Container */}
                    <div className="relative h-48 overflow-hidden">
                      ...
                      {deal.popular && (
                        <motion.div
                          initial={{ scale: 0 }}
                          animate={{ scale: 1 }}
                          transition={{ delay: (index % totalItems) * 0.1 + 0.5 }}
                      ...
                      {deal.discount && (
                        <motion.div
                          initial={{ scale: 0 }}
                          animate={{ scale: 1 }}
                          transition={{ delay: (index % totalItems) * 0.1 + 0.7 }}
                      ...
                      >
                        ...
                        <span className="text-xs opacity-80">({deal.reviews})</span>
                      </motion.div>
                    </div>
                    ...
                    {/* Hover Border Effect */}
                    <div className="absolute inset-0 border-2 border-transparent bg-gradient-to-r from-blue-500 to-emerald-500 rounded-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 -z-10"></div>
                  </motion.div>
                </motion.div>
              ))}
            </motion.div>
        ...
        >
          ...
          >
            ...
            >
              ...
              <span className="relative z-10">Explore All 50+ Destinations</span>
