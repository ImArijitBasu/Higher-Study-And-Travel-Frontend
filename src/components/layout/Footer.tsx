...
const Footer = () => {
    return (
        <footer className="bg-white py-10 text-justify">
            {/* Top Blue Banner */}
            <div className="bg-[#8bd8f7] max-w-11/12 mx-auto flex flex-col md:flex-row justify-around items-center px-6 md:px-16 py-8 rounded-2xl shadow-sm gap-6">
                ...
                <ul className="flex gap-6 text-2xl mt-4 md:mt-0">
                    <Link href="#" className="hover:text-blue-700"><FaFacebookF /></Link>
                    <Link href="#" className="hover:text-pink-500"><IoLogoInstagram /></Link>
                    <Link href="#" className="hover:text-red-600"><FaYoutube /></Link>
                    <Link href="#" className="hover:text-gray-700"><MdOutlineMail /></Link>
                </ul>
            </div>
            ...
            {/* copyright section */}
            <div className="bg-gradient-to-r mt-16 from-[#8bd8f7] to-[#64cdf4] text-center py-5 text-sm text-white font-semibold rounded-t-md">
                <p>
